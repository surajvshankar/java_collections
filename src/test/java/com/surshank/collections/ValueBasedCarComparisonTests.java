...
public class ValueBasedCarComparisonTests {
  Collection<Car> cars;
  ...
  public void setUp(TestInfo info) throws Exception {
    ...
    this.subaru = new ValueBasedCar("Subaru", "Impreza", 52000);
    this.tesla = new ValueBasedCar("Tesla", "Model S", 10000);
    this.honda = new ValueBasedCar("Honda", "Civic", 2500);
  ...
  public void removeTest() {
    ...
    this.cars.remove(new ValueBasedCar("Subaru", "Impreza", 52000));
  ...
  public void containsTest() {
    assertTrue(this.cars.contains(new ValueBasedCar("Tesla", "Model S", 9000)));
  ...
  public void removeAllIdentityTest() {
    this.cars.removeAll(Arrays.asList(this.subaru, this.tesla, this.honda = new ValueBasedCar("Honda", "Civic", 250)));
